              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-beige-500 focus:border-transparent outline-none transition-all resize-none"
                    placeholder="Tell us about your project..."
                  />
                </div>
                <button
                  type="submit"
                  className="w-full bg-beige-500 hover:bg-beige-600 text-white px-6 py-4 rounded-lg font-semibold text-lg transition-colors"
                >
                  Send Message
                </button>
              </form>
            ...
            <div className="space-y-8">
              <div className="bg-white rounded-lg p-8 md:p-12 shadow-sm">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start">
                    <div className="w-12 h-12 bg-beige-100 rounded-lg flex items-center justify-center mr-4 flex-shrink-0">
                      <svg className="w-6 h-6 text-beige-600" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div className="bg-gray-100 rounded-lg p-8 md:p-12">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Pure Services is a trusted building contractor with years of experience delivering 
                  quality construction, maintenance, and outdoor services. We pride ourselves on our 
                  personal approach, working closely with each client to understand their needs and 
                  deliver exceptional results. Our commitment to quality, reliability, and agility 
